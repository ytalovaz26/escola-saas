...
function canManageSchool(roleRaw: any) {
  ...
  // no seu enum: diretor / coordenador
...
export async function GET(req: Request) {
  try {
    ...
    // 2) pega vínculo ATIVO do usuário em school_users (pra pegar school_id e role)
    ...
    // 3) lista turmas da escola
    // ⚠️ Ajuste aqui caso seu schema use outros nomes de coluna.
    // Pelo seu print: classes tem (id, school_id, name, grade, shift, created_at ...)
